...
const MusicItem = ({
  ...
  return (
    <article className={`w-[90%] mb-4 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] ${changeSize && 'hover:scale-105'}`}>
      ...
      <div className="rounded-[10px] bg-white p-4 sm:p-6 dark:bg-slate-950">
        ...
        <div className="flex items-end justify-between h-fit">
          <div className="flex flex-wrap gap-1 mt-4">
            {
              tags?.map((tag) => <Tag color="purple" key={tag}>{tag}</Tag>)
            }
          </div>
          <div className="flex">
