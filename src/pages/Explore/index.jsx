...
const Explore = () => {
    ...
    return (
        <Dashboard>
            <section className="relative grid h-full grid-cols-1 grid-rows-[350px_auto_300px] gap-4 pt-6 mb-4 sm:grid-cols-2 lg:grid-cols-4">
                <Card isFooterBlurred className="w-full h-full col-span-12 sm:col-span-1">
                ...
                <Card
                    isBlurred
                    className="col-span-12 border-none sm:col-span-2 bg-background/60 dark:bg-default-100/50"
                    shadow="sm"
                >
                    <CardBody>
                        <div className="grid items-center justify-center h-full grid-cols-6 gap-6 md:grid-cols-12 md:gap-4">
                ...
                <div className="flex flex-col w-full row-start-2 col-span-full">
                    <Tabs aria-label="Options">
                        <Tab key="playlists" title="Playlists" className='flex flex-col items-start' as={motion.div} layout transition={{
                            duration: 0.3, height: { duration: 0.3, ease: "easeInOut" },
                ...
                <Card className="h-full col-span-12 row-start-3 sm:col-span-1">
                ...
                <Table aria-label="Example table with dynamic content" className='col-span-12 row-start-3 sm:col-span-3'>
                ...
                <div className="sticky bottom-0 w-full col-span-4 bg-white">
                    <div className="grid items-center justify-center w-full grid-cols-6 gap-6 bg-white md:grid-cols-12 md:gap-4">
                        <div className="flex flex-col col-span-6 md:col-span-12">
                            <div className="flex items-start justify-between">
                                <div className="flex flex-col gap-0 p-3">
                                    <h1 className="mt-2 font-medium text-large">Frontend Radio</h1>
                                    <p className="text-small text-foreground/80">Jhon</p>
                                </div>
                                <Button
                                    isIconOnly
                                    className="text-default-900/60 data-[hover]:bg-foreground/10 -translate-y-2 translate-x-2"
